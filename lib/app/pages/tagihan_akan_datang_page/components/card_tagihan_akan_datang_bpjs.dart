...
class CardTagihanAkanDatangBPJS extends StatelessWidget {
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text("No. VA : $noTagihan", style: tsLabelRegularDarkBlue),
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: SvgPicture.asset(
                        "assets/icons/icKategoriBPJS.svg",
                        width: 24,
                      ),
                    ),
                    ...
                    Column(
                      ...
                      children: [
                        Container(
                            width: width * 0.685,
                            child: Text("Tagihan BPJS $namaTagihan", style: tsBodySmallSemiboldBlack)
                        ),
                        SizedBox(height: 4),
